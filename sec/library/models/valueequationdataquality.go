...
type ValueEquationDataQuality struct {
	...
	Date                         time.Time `bson:"Period.Dates" json:"Date"`
...
// IncentiveDocuments
type VEDQIncentiveDocuments struct {
	sync.RWMutex
	orm.ModelBase `bson:"-" json:"-"`
	Id            int64  `bson:"Id" json:"Id"`
	VEId          int64  `bson:"VEId" json:"VEId"`
...
func (m *VEDQIncentiveDocuments) TableName() string {
	return "VEDQIncentiveDocuments"
}
