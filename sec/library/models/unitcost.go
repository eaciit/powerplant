...
type UnitCost struct {
	...
	FuelInvoiceCostDeisel                   float64 `bson:"FuelInvoiceCostDeisel" json:"FuelInvoiceCostDeisel"`
	FuelInvoiceCostHavey                    float64 `bson:"FuelInvoiceCostHavey" json:"FuelInvoiceCostHavey"`
	FuelInvoiceCostLightCrudeOilfilteration float64 `bson:"FuelInvoiceCostLightCrudeOilfilteration" json:"FuelInvoiceCostLightCrudeOilfilteration"`
	FuelInvoiceCostHaveyCrudeOilfilteration float64 `bson:"FuelInvoiceCostHaveyCrudeOilfilteration" json:"FuelInvoiceCostHaveyCrudeOilfilteration"`
